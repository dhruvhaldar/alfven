...
class PlasmaState:
    ...
    def __init__(self, n, T_ev):
        ...
        """
        # Assign via properties to populate precomputed caches
        self.n = n
        self.T_ev = T_ev
    ...
    def debye_length(self):
        ...
        # ⚡ Bolt: Use precomputed square roots to save redundant function calls.
    ...
    def plasma_frequency(self):
        ...
        # ⚡ Bolt: Precompute math.sqrt(_PLASMA_FREQ_CONST) to save computation.
    ...
    def larmor_radius(self, B):
        ...
        # ⚡ Bolt: Use precomputed square root to save redundant function call.
